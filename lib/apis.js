...
// ★ FIX: every raw fetch() in this file now has a hard timeout via AbortController,
//        so a dead endpoint returns an error to WhatsApp instead of hanging forever.
...
// ── PWNED ★ FIX: timed request via httpGetText ─────────────────────────────
...
// ── QR ★ FIX: both directions now have hard timeouts ───────────────────────
